...
- [Event store](guide/event-store.md) — implement or evaluate an adapter.
...
- [Capability matrix](project/capability-matrix.md) — distinguish library
  guarantees from production adapter and deployment responsibilities.
- [API reference](reference/api.md) — find the public protocol grouped by
  system.

The repository is intentionally small at the boundary: a production adapter
